    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        ...
        <div class="collapse navbar-collapse navbar-ex1-collapse">
            <ul class="nav navbar-nav side-nav itdragon-nav">
                ...
                <li>
                    <a href="/sys/user"><i class="fa fa-fw fa-bar-chart-o"></i> Employees</a>
                </li>
                <!-- 只有角色为admin或manager的用户才有权限访问  -->
                <shiro:hasAnyRoles name="admin,manager">
                <li>
                    <a href="/sys/permission"><i class="fa fa-fw fa-table"></i> Permissions</a>
                </li>
                </shiro:hasAnyRoles>
                <!-- 只有角色为admin的用户才有权限访问  -->
                <shiro:hasRole name="admin">
                <li>
                    <a href="/sys/role"><i class="fa fa-fw fa-file"></i> Roles</a>
                </li>
                </shiro:hasRole>
            </ul>
        </div>
